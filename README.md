...
- **69 automated tests** cover messaging, identity, queue/native failure handling, storage and installation guards.
...
Version-tag pushes prepare a verified **release draft** after both platform checks pass. Branch, PR and manual runs produce only a CI candidate. Publication remains manual. [Release automation](docs/release-automation.de.md).
